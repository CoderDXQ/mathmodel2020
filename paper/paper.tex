...
对于辛烷值进行特征筛选，选出的主要操作变量是：'稳定塔下部温度'， '精制汽油出装置温度'， '精制汽油出装置硫含量'， '加热炉主火嘴瓦斯入口压力'， 'E-101D壳程出口管温度'， 'D-204液位'， 'D-102温度'， 'R-101下部床层压降'， 'P-101B入口过滤器差压'， 'F-101出口支管\#4温度'， 'D101原料缓冲罐压力'；对于硫进行建模，选出的主要操作变量是：
